...
- **Bookstack LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/bookstack-install.sh)
  - NEW Script
- **Vikunja LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/vikunja-install.sh)
  - NEW Script
...
- **Automatic Update of Repository:** The update function now uses the new repository `remz1337/ProxmoxVE` for Debian/Ubuntu LXC containers.
  ...
  ```bash
  bash -c "$(wget -qLO - https://github.com/remz1337/ProxmoxVE/raw/remz/misc/update-repo.sh)"

## 2024-10-31

### Changed

- **NZBGet LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/nzbget-install.sh)
  - NEW Script
- **Memos LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/memos-install.sh)
  - NEW Script
...
- **Open WebUI LXC** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/8a21f6e7f025a911865395d4c0fa9a001bd0d512)
...
- **AdventureLog LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/adventurelog-install.sh)
  - NEW Script
...
- **Zoraxy LXC** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/468a5d367ded4cf453a1507452e112ac3e234e2a)
...
- **Wallos LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/wallos-install.sh)
  - NEW Script
- **Open WebUI LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/openwebui-install.sh)
  - NEW Script
...
- **Cockpit LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/cockpit-install.sh)
  - NEW Script
- **Neo4j LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/neo4j-install.sh)
  - NEW Script
...
- **ArchiveBox LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/archivebox-install.sh)
  - NEW Script
...
- **evcc LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/evcc-install.sh)
  - NEW Script
...
- **MySQL LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/mysql-install.sh)
  - NEW Script
- **Tianji LXC** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/4c83a790ac9b040da1f11ad2cbe13d3fc5f480e9)
  - Breaking Change
...
- **Home Assistant Core LXC** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/f2937febe69b2bad8b3a14eb84aa562a8f14cc6a) [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/f2966ced7f457fd506f865f7f5b70ea12c4b0049)
  - Refactor Code
  - Breaking Change
...
- **HomeBox LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/homebox-install.sh)
  - NEW Script
- **Zipline LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/zipline-install.sh)
  - NEW Script
...
- **Tianji LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/tianji-install.sh)
  - NEW Script
...
- **WireGuard LXC** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/723365a79df7cc0fd29b1af8f7ef200a7e0921b1)
  - Refactor Code
  - Breaking Change
...
- **CommaFeed LXC** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/0a33d1739ec3a49011411929bd46a260e92e99f9)
  - Refactor Code
  - Breaking Change
...
- **lldap LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/lldap-install.sh)
  - NEW Script
...
- **Gitea LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/gitea-install.sh)
  - NEW Script
...
- **All Scripts** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/39ea1d4a20b83c07d084ebafdc811eec3548f289)
...
- **Kubo LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/kubo-install.sh)
  - NEW Script
- **RabbitMQ LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/rabbitmq-install.sh)
  - NEW Script
- **Scrutiny LXC**
...
- **MySpeed LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/myspeed-install.sh)
  - NEW Script
...
- **PeaNUT LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/peanut-install.sh)
  - NEW Script
- **Website**
  - If the Changelog has changed recently, the link on the website will pulse.
- **Spoolman LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/spoolman-install.sh)
  - NEW Script
...
- **MeTube LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/metube-install.sh)
  - NEW Script
- **Matterbridge LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/matterbridge-install.sh)
  - NEW Script
- **Website**
...
- **Zabbix LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/zabbix-install.sh)
  - NEW Script
...
- **Petio LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/petio-install.sh)
  - NEW Script
- **Website**
...
- **FlareSolverr LXC** [(View Source)](https://github.com/remz1337/ProxmoxVE/blob/remz/install/flaresolverr-install.sh)
  - NEW Script
...
- **Advanced Settings** [(Commit)](https://github.com/remz1337/ProxmoxVE/commit/fc9dff220b4ea426d3a75178ad8accacae4683ca)
...
- **Proxmox VE Monitor-All**
  - Skip instances based on onboot and templates. [8c2a3cc](https://github.com/remz1337/ProxmoxVE/commit/8c2a3cc4d774fa13d17f695d6bdf9a4deedb1372). 
...
- **[User Submitted Guides](https://github.com/remz1337/ProxmoxVE/blob/remz/USER_SUBMITTED_GUIDES.md)**
...
- **Proxmox LXC Updater** 
  - Now updates Ubuntu, Debian, Devuan, Alpine Linux, CentOS-Rocky-Alma, Fedora, ArchLinux [(@Uruknara)](https://github.com/remz1337/ProxmoxVE/commits?author=Uruknara)
